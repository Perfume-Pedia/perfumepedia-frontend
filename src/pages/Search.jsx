...
export default function Search() {
  ...
  const handleBookmarkClick = (uuid) => {
    const updatedItems = items.map((item) => {
      if (item.uuid === uuid) {
        const isBookmarked =
          localStorage.getItem(`favPerfume_${uuid}`) === "true";
        ...
        <div className="item-container">
          {firstSectionItems.map((item, index) => (
            <div
              ...
              className="item"
              onClick={() => handleItemClick(item.uuid, item.perfume_name)}
            ...
            >
              ...
              <div className="item-info">
                <img
                  ...
                  src={
                    localStorage.getItem(`favPerfume_${item.uuid}`) === "true"
                      ? "img/bookmarks-click.png"
                      : "img/bookmarks-nonclick.png"
                  }
                  alt="북마크"
                  onClick={(e) => {
                    e.stopPropagation();
